...
class AddWordsRow extends Component {
	...
	confirm = () => {
		if ((this.state.word !== '') & (this.state.description !== '')) {
			this.props.addNewWord(this.state.word.trim(), this.state.description.trim(), this.state.img.trim());
			this.setState({ word: '', description: '',img: '', });
			...
			<React.Fragment>
				<div className={styles.RowWrapper}>
					<div className={styles.Row}>
						<div className={styles.AddWords}>Thêm từ mới:</div>
					</div>
				</div>
				<div className={styles.RowWrapper}>
					<div className={styles.Row}>
