					...
					<div className={styles.CardTop}>
						...
						<div className={styles.CardMainContainer}>
							...
							<div className={styles.WordsLearned}>
								{course.wordsLearned}/{course.totalWords} Từ đã học
							</div>
							<div className={styles.ProgressBar}>
								<div style={progressWidth} className={styles.Progress} />
							</div>
							{progress === 100 && <div className={styles.CourseCompleted}>Chủ đề đã hoàn thành!</div>}
						</div>
					</div>
					<div className={styles.CardBottom}>
						...
						<div onClick={() => this.learn()} className={nextUpButtonClasses}>
							...
							<div className={styles.NextUpLabel}>
								<div className={styles.NextUpText}>Tiếp theo</div>
								<div>Học từ mới.....</div>
							</div>
