			...
			<React.Fragment>
				...
				<div className={styles.PageHead}>
					<div className={styles.PageHeadRow}>
						<div className={styles.Title}>Tạo chủ đề</div>
					</div>
				</div>
				<div className={styles.WhiteBox}>
					<div className={styles.Label}>Tên chủ đề:</div>
					<input
						onChange={this.nameChange}
						maxLength="100"
						className={this.state.nameInputClasses}
					/>
					<div className={styles.Label}>Dạy:</div>
					<select
						onChange={this.teachingChange}
						defaultValue="Please"
						className={this.state.teachingClasses}
					>
						<option value={'Please'}>Hãy chọn một...</option>
						{languages.map(l => (
					...
					<div className={styles.Label}>Cho:</div>
